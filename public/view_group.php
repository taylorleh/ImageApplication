...
<?php  $vendor = new Vendor; ?>
 ...
 <div id="main">
    ...
    <div id="<?php echo $group['product_family']; ?>" class="image-grid">
        <div class="sub-menu">
            ...
            <form style="display: inline-block;" action='createcomment.php' method="post" id="approveall">
...
<?php endwhile; ?>
    ...
    <div class="summary">
        ...
        <?php foreach($group_set as $value): ?>
            <li>
                <p class="image-id"><?php echo $value->product_family; ?></p>
    ...
    <iframe id="frame" src="http://intranet.dev:8080/viewframe.php" width="346px" height="396px" allowTransparency="true"></iframe>
    <button id="showgrid">Show Grid</button>
    <!-- <button id='reset'>Reset</button> -->
    <button id="submitcomment">Submit As Comment</button>
    </div>
    <section style="text-align: center; width:85%;">
        <form class="resize-data">        
                <!-- <label>Percentage:<input id="percent" readonly type="text"></label> -->
                <label><input id="widthmod" type="text" >width:<input name="labelWidth" id="labelWidth" type="number"></label>
                <label><input id="heightmod" type="text">height:<input name="labelHeight" id="labelHeight" type="number"></label>
